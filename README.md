...
```
cd existing_repo
git remote add origin https://gitlab.mff.cuni.cz/provaja/scheme.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.mff.cuni.cz/provaja/scheme/-/settings/integrations)
